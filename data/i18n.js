  ...
  var I18N = {
    sv: {
      ...
      ui: {
        ...
        closingInMinutes: 'Stänger om {min} min',
        nearYou: 'Nära dig',
        locationFallback: 'Mallorca (hela ön)',
        locationDenied: 'Platsåtkomst nekad – tillåt i inställningarna',
    ...
    en: {
      ...
      ui: {
        ...
        closingInMinutes: 'Closing in {min} min',
        nearYou: 'Near you',
        locationFallback: 'Mallorca (whole island)',
        locationDenied: 'Location access denied – allow it in settings',
    ...
    de: {
      ...
      ui: {
        ...
        closingInMinutes: 'Schließt in {min} Min.',
        nearYou: 'In deiner Nähe',
        locationFallback: 'Mallorca (ganze Insel)',
        locationDenied: 'Standortzugriff verweigert – in den Einstellungen erlauben',
    ...
    fr: {
      ...
      ui: {
        ...
        closingInMinutes: 'Ferme dans {min} min',
        nearYou: 'Près de vous',
        locationFallback: 'Majorque (île entière)',
        locationDenied: "Accès à la position refusé – autorisez-le dans les réglages",
    ...
    es: {
      ...
      ui: {
        ...
        closingInMinutes: 'Cierra en {min} min',
        nearYou: 'Cerca de ti',
        locationFallback: 'Mallorca (toda la isla)',
        locationDenied: 'Acceso a la ubicación denegado – permítelo en los ajustes',
